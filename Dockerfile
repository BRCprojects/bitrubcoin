...
VOLUME /root/.bitrubcoin

# Generate your wallet via accessing the container and run:
# cd /wallet
# bitrubcoin-wallet-cli
VOLUME /wallet

EXPOSE 11180
EXPOSE 11181

ENTRYPOINT ["bitrubcoind", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=11180", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=11181", "--non-interactive", "--confirm-external-bind"]
