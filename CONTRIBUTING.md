# Contributing to BitRubCoin

Being a fork of Monero, BitRubCoin shares most of its codebase with Monero while making a few critical modifications such
...
request to Monero first, then send a corresponding PR to BitRubCoin by cherry-picking, as described above. If your Monero PR
is merged, your corresponding BitRubCoin PR will then be merged subsequently.

If you are to propose some changes that are specific to BitRubCoin and distinct from Monero, submit a pull request directly
to BitRubCoin and justify your changes by laying out how they are *more* or *uniquely* applicable to BitRubCoin. With a good
